import fs from "fs";
import LogDefinitions from './LogDefinitions.json' assert { type: 'json' };
...
export default class Logger {
    ...
    */
    ...
    /**
     *  Helper function to return the log verbosity enum, removing the requirement for other classes / modules to directly import the log definitions as 
     * well as the logger.
     * @returns {object} logVerbosity json struct.
     */
    static GetLogVerbosityEnum() {
        return LogDefinitions.logVerbosity;
    }
